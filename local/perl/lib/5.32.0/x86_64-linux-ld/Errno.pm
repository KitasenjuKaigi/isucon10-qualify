...
"x86_64-linux-ld-4.15.0-117-generic" or
	die "Errno architecture (x86_64-linux-ld-4.15.0-117-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
